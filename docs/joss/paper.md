...
Further extensions of JURASSIC include tomographic retrieval capabilities for mesoscale atmospheric structures from airborne and satellite measurements [@Ungermann2010; @Ungermann2012] as well as a GPU-accelerated implementation for efficient execution on heterogeneous computing architectures [@Baumeister2022]. More recently, the clear-air, scattering-enabled, and GPU-accelerated variants have been integrated into a single unified code base, referred to as JURASSIC-UNIFIED, to improve maintainability, extensibility, and long-term sustainability through a modular, library-oriented software design.
...
User and developer documentation is provided through a comprehensive README, example projects, and an online wiki hosted with the source code repository, facilitating installation, configuration, and extension of the model.
